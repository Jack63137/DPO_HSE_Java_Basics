...
public class CaesarCipher {
    ...
    /**
     * Определяет язык символа и возвращает его позицию в соответствующем алфавите.
     * 
     * @param c Символ для проверки
     * @return Позиция символа в соответствующем алфавите или -1, если символ не относится к поддерживаемым алфавитам
     */
    public int getCharPosition(char c) {
        ...
        // Для русских букв без учета буквы 'ё' (стандартный порядок Unicode)
        if ((c >= 'А' && c <= 'Я')) {
            return c - 'А';
        } else if (c >= 'а' && c <= 'я') {
            return c - 'а';
